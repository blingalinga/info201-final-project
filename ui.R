...
intro_tab <- tabPanel(
  ...
  fluidPage(
    ...
    h4("Project by: Charlie Schoos, Henry Tran, Ling Ling Lee, Christopher Johnson"),
    ...
    img(src = "https://img.theweek.in/content/dam/week/news/sci-tech/images/2019/4/1/co2-gas-pollution-carbon-dioxide-emission-gas-shut.jpg", align="center"),
